...
import info.novatec.novaspy.rcp.editor.tree.input.TreeInputController;
...
public class ExceptionTreeDetailInputController implements TreeInputController {
	 ...
	 */
	public static final String ID = "novaspy.subview.tree.exceptiontreedetail";
	...
	private static enum Column {
		...
		/** The method column. */
		METHOD_CONSTRUCTOR("Method / Constructor", 500, NovaSpyConstants.IMG_CALL_HIERARCHY),
