...
import info.novatec.novaspy.rcp.editor.composite.GridCompositeSubView;
import info.novatec.novaspy.rcp.editor.composite.SashCompositeSubView;
import info.novatec.novaspy.rcp.editor.composite.TabbedCompositeSubView;
import info.novatec.novaspy.rcp.editor.exception.input.ExceptionOverviewInputController;
import info.novatec.novaspy.rcp.editor.exception.input.ExceptionTreeDetailInputController;
import info.novatec.novaspy.rcp.editor.exception.input.ExceptionTreeOverviewInputController;
import info.novatec.novaspy.rcp.editor.exception.input.ExceptionTreeStackTraceInputController;
import info.novatec.novaspy.rcp.editor.graph.GraphSubView;
import info.novatec.novaspy.rcp.editor.table.TableSubView;
import info.novatec.novaspy.rcp.editor.table.input.AggregatedTimerSummaryInputController;
import info.novatec.novaspy.rcp.editor.table.input.CombinedMetricsInputController;
import info.novatec.novaspy.rcp.editor.table.input.InvocOverviewInputController;
import info.novatec.novaspy.rcp.editor.table.input.MethodInvocInputController;
import info.novatec.novaspy.rcp.editor.table.input.SqlInputController;
import info.novatec.novaspy.rcp.editor.table.input.SqlInvocInputController;
import info.novatec.novaspy.rcp.editor.text.TextSubView;
import info.novatec.novaspy.rcp.editor.text.input.ClassesInputController;
import info.novatec.novaspy.rcp.editor.text.input.CpuInputController;
import info.novatec.novaspy.rcp.editor.text.input.MemoryInputController;
import info.novatec.novaspy.rcp.editor.text.input.ThreadsInputController;
import info.novatec.novaspy.rcp.editor.text.input.VmSummaryInputController;
import info.novatec.novaspy.rcp.editor.traceinspector.TraceInspectorSubView;
import info.novatec.novaspy.rcp.editor.tree.TreeSubView;
import info.novatec.novaspy.rcp.editor.tree.input.InvocDetailInputController;
...
public final class SubViewFactory {
	...
	public static ISubView createSubView(SensorTypeEnum sensorTypeEnum) {
		...
		case INVOCATION_SEQUENCE:
			...
			invocTabbedSubView.addSubView(invocDetails, "Call Hierarchy", NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_CALL_HIERARCHY));
			invocTabbedSubView.addSubView(invocSql, "SQL", NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_DATABASE));
			invocTabbedSubView.addSubView(invocMethods, "Methods", NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_METHOD_PUBLIC));
			// invocTabbedSubView.addSubView(traceInspector, "Trace Inspector",
			// NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_CALL_HIERARCHY));
		...
		case EXCEPTION_TRACER:
			...
			exceptionTreeTabbedSubView.addSubView(exceptionTreeDetails, "Details", NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_CALL_HIERARCHY));
			exceptionTreeTabbedSubView.addSubView(stackTraceInput, "Stack Trace", NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_STACKTRACE));
