package info.novatec.novaspy.rcp.editor.root;
...
import info.novatec.novaspy.rcp.editor.SubViewFactory;
import info.novatec.novaspy.rcp.editor.preferences.IPreferencePanel;
import info.novatec.novaspy.rcp.editor.preferences.PreferenceEventCallback;
import info.novatec.novaspy.rcp.editor.preferences.PreferenceId;
import info.novatec.novaspy.rcp.editor.preferences.PreferenceId.LiveMode;
			...
			Display.getDefault().asyncExec(new Runnable() {
				public void run() {
					try {
						...
						NovaSpy.getDefault().createErrorDialog("The update mechanism on the view failed!", e, -1);
					}
				}
			});
		}
