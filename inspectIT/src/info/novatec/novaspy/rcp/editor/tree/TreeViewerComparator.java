 ...
 * 
 */
public abstract class TreeViewerComparator<E> extends ViewerComparator {
	 ...
	 */
	public final void addColumn(final TreeColumn column, final Enum<?> id) {
		column.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				tree.setSortDirection(sortState.swtDirection);
			}
		});
	}
