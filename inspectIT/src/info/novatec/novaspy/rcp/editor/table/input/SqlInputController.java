...
public class SqlInputController extends AbstractTableInputController {
	 ...
	 */
	public static final String ID = "novaspy.subview.table.sql";
	...
	private static enum Column {
		...
		STATEMENT("Statement", 600, NovaSpyConstants.IMG_DATABASE),
		/** The count column. */
		COUNT("Count", 80, null),
		/** The average column. */
		...
		/** The method column. */
		METHOD("Method", 500, NovaSpyConstants.IMG_METHOD_PUBLIC);
