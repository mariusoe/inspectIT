...
public class SqlInvocInputController extends AbstractTableInputController {
	 ...
	 */
	public static final String ID = "novaspy.subview.table.sqlinvoc";
	...
	private static enum Column {
		...
		TIMESTAMP("Timestamp", 130, NovaSpyConstants.IMG_TIMER),
		/** The duration column. */
		DURATION("Duration (ms)", 70, NovaSpyConstants.IMG_LAST_HOUR),
		/** The prepared column. */
		PREPARED("Prepared?", 60, null),
		/** The statement column. */
		STATEMENT("Statement", 800, NovaSpyConstants.IMG_DATABASE);
