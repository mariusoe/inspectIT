...
public class InvocOverviewInputController extends AbstractTableInputController {
	 ...
	 */
	public static final String ID = "novaspy.subview.table.invocoverview";
	...
	private static enum Column {
		/** The time column. */
		TIME("Start Time", 150, NovaSpyConstants.IMG_TIMER),
		/** The method column. */
		METHOD("Method", 600, NovaSpyConstants.IMG_METHOD_PUBLIC),
		/** The duration column. */
		DURATION("Duration (ms)", 120, NovaSpyConstants.IMG_LAST_HOUR),
		/** The count column. */
