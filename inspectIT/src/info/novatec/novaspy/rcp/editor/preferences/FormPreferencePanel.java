...
import info.novatec.novaspy.rcp.editor.preferences.control.IPreferenceControl;
...
public class FormPreferencePanel implements IPreferencePanel {
	...
	private final class SwitchPreferences extends Action {
		...
		private SwitchPreferences(String text) {
			...
			setImageDescriptor(NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_PREFERENCES));
		}
	...
	private final class UpdateAction extends Action {
		...
		private UpdateAction(String text) {
			super(text);
			setImageDescriptor(NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_REFRESH));
		}
	...
	private final class SwitchLiveMode extends Action {
		...
		public SwitchLiveMode(String text) {
			super(text);
			setImageDescriptor(NovaSpy.getDefault().getImageDescriptor(NovaSpyConstants.IMG_LIVE_MODE));
			setChecked(true);
		}
