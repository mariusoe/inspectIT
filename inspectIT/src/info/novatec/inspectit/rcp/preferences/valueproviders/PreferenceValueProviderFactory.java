	...
	public static <E> String getValueForObject(String preferenceKey, E object) throws PreferenceException {
		...
		if (null != preferenceValueProvider) {
			if (preferenceValueProvider.isObjectValid(object)) {
				...
				throw new PreferenceException("Preferance value for key " + preferenceKey + " could  not be obtained because the supplied object is not valid.");
			}
		} else {
			throw new PreferenceException("Preferance value provider was not found for preference key: " + preferenceKey);
		}
	}
