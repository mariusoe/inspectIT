...
import info.novatec.inspectit.rcp.editor.graph.plot.aggregation.ClassesDataAggregator;
import info.novatec.inspectit.rcp.editor.graph.plot.aggregation.CpuDataAggregator;
import info.novatec.inspectit.rcp.editor.graph.plot.aggregation.IDataAggregator;
import info.novatec.inspectit.rcp.editor.graph.plot.aggregation.MemoryDataAggregator;
import info.novatec.inspectit.rcp.editor.graph.plot.aggregation.ThreadsDataAggregator;
import info.novatec.inspectit.rcp.editor.graph.plot.aggregation.TimerDataAggregator;
