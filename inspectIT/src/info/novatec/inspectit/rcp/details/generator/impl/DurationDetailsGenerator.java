...
public class DurationDetailsGenerator implements IDetailsGenerator {
	...
	public DetailsTable generate(DefaultData defaultData, RepositoryDefinition repositoryDefinition, Composite parent, FormToolkit toolkit) {
		...
		DetailsCellContent[] total = new DetailsCellContent[] {
				new DetailsCellContent(NumberFormatter.formatDouble(timerData.getDuration()))
		};
		...
		if (timerData.isCpuMetricDataAvailable()) {
			...
			DetailsCellContent[] cpu = new DetailsCellContent[] {
				new DetailsCellContent(NumberFormatter.formatDouble(timerData.getCpuDuration()))
			};
		...
		if (timerData.isExclusiveTimeDataAvailable()) {
			...
			DetailsCellContent[] exclusive = new DetailsCellContent[] {
				new DetailsCellContent(NumberFormatter.formatDouble(timerData.getExclusiveDuration()))
			};
