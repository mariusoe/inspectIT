...
/**
 * The registration service is used and called by all NovaSpy Agents. First,
...
public interface IRegistrationService extends Remote {
	 ...
	 *             registering process.
	 */
	long registerMethodIdent(long platformIdent, String packageName, String className, String methodName, List parameterTypes, String returnType, int modifiers) throws RemoteException;
