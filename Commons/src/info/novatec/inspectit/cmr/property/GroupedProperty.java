...
import info.novatec.inspectit.cmr.property.validation.validators.IGroupedProperyValidator;
...
public class GroupedProperty extends AbstractProperty {
	...
	@XmlElementRef
	private Set<SingleProperty<?>> singleProperties = new HashSet<SingleProperty<?>>();
