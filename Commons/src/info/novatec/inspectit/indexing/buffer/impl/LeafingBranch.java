...
public class LeafingBranch<E extends DefaultData> extends Branch<E> {
	 ...
	 * @param branchIndexer 
	 */
	public LeafingBranch(IBufferBranchIndexer<E> branchIndexer) {
		super(branchIndexer);
	}
	...
	public E put(E element) throws IndexingException {
		E returnElement = super.put(element);
		leaf.put(element);
	...
	private boolean isQueryIndexedUnder(IIndexQuery query) {
		IBufferBranchIndexer<E> branchIndexer = getBufferBranchIndexer().getChildIndexer();
