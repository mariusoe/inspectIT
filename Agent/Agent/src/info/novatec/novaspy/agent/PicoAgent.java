package info.novatec.novaspy.agent;

import info.novatec.novaspy.agent.analyzer.IByteCodeAnalyzer;
...
import info.novatec.novaspy.agent.analyzer.impl.ByteCodeAnalyzer;
...
import info.novatec.novaspy.agent.config.IConfigurationReader;
...
import info.novatec.novaspy.agent.connection.impl.RMIConnection;
...
import info.novatec.novaspy.agent.sensor.exception.IExceptionTracingSensor;
import info.novatec.novaspy.agent.sensor.method.IMethodSensor;
import info.novatec.novaspy.agent.sensor.method.jdbc.StatementStorage;
...
public class PicoAgent {
	 ...
	 * them.
	 */
	private static final String[] IGNORE_START_PATTERNS = new String[] { "info.novatec.novaspy.agent.", "sun.misc.reflect", "$Proxy" };
