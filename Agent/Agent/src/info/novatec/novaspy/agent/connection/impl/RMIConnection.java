...
import info.novatec.novaspy.cmr.service.LicenseException;
...
public class RMIConnection implements IConnection {
	 ...
	 */
	private String agentStorageName = "NovaSpyAgentStorageService";

	/**
	 * The name of the registration service.
	 */
	private String registrationName = "NovaSpyRegistrationService";
