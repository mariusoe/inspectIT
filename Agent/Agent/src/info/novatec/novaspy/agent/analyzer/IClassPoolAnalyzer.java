...
public interface IClassPoolAnalyzer {
	...
	/**
	 * Returns all the methods of a class as an array of {@link CtMethod}
	 * objects.
	 * 
	 * @param classLoader
	 *            The class loader of the given class name to successfully
	...
	/**
	 * Returns all the constructors of a class as an array of
	 * {@link CtConstructor} objects.
	 * 
	 * @param classLoader
	 *            The class loader of the given class name to successfully
	 *            search for the class.
	 * @param className
	 *            The name of the class.
	 * @return The array of {@link CtConstructor} objects of the passed class
	 *         name.
	 */
	...
	/**
	 * Returns the {@link ClassPool} which is responsible for the given class
	 * loader.
	 * 
	 * @param classLoader
	 *            The class loader.
