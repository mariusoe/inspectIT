...
/**
 * This class enables that {@link SpringConfiguration} processes the
 * {@link ConfigurationStorage} after it has been successfully initialized.
 * <p>
 * The definition if this bean is set in the <i>spring/spring-context-beans.xml</i> file.
 * 
 * @author Ivan Senic
 * 
 */
