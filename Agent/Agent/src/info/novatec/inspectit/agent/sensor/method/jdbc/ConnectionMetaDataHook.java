...
/**
 * This hook records the meta data information of a connection and stores this into a map for later retrieval.
 * 
 * @author Stefan Siegl
 *
 */
public class ConnectionMetaDataHook implements IConstructorHook {
	 ...
	 * @param connectionMetaDataStorage the connection storage.
	 */
