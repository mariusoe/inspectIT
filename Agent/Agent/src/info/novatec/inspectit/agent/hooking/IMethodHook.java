...
/**
 * Classes which add a hook into a method before and after it is called, have to
...
public interface IMethodHook extends IHook {
	...
	/**
	 * This method is executed before something else in the original method body
	 * will be executed.
	 * 
	 * @param methodId
	...
	/**
	 * This method will be called before the original method will return. It is
	 * the first of two after body calls. It is important that a hook,
	 * implementing this method, just adds time or memory critical settings.
	 * Everything else, including computing or adding values to the value
	...
	/**
	 * This method will be called before the original method will return. It is
	 * the second of two after body calls. This method can be used to save or
	 * compute some values.
	 * 
	 * @param coreService
