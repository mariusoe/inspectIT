 ...
 *
 * @see info.novatec.inspectit.javassist.CtClass#instrument(ExprEditor)
 * @see info.novatec.inspectit.javassist.CtMethod#instrument(ExprEditor)
 * @see info.novatec.inspectit.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
