 ...
 *
 * @see info.novatec.inspectit.javassist.tools.reflect.Reflection
 * @see info.novatec.inspectit.javassist.tools.reflect.Compiler
 * @see info.novatec.inspectit.javassist.Loader
 */
public class Loader extends info.novatec.inspectit.javassist.Loader {
    ...
    public Loader() throws CannotCompileException, NotFoundException {
        super();
        delegateLoadingOf("info.novatec.inspectit.javassist.tools.reflect.Loader");
