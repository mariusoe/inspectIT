...
package info.novatec.inspectit.javassist.tools.reflect;

import info.novatec.inspectit.javassist.*;
import info.novatec.inspectit.javassist.CtMethod.ConstParameter;
 ...
 * </pre></ul>
 *
 * @see info.novatec.inspectit.javassist.tools.reflect.ClassMetaobject
 * @see info.novatec.inspectit.javassist.tools.reflect.Metaobject
 * @see info.novatec.inspectit.javassist.tools.reflect.Loader
 * @see info.novatec.inspectit.javassist.tools.reflect.Compiler
 */
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "info.novatec.inspectit.javassist.tools.reflect.Metaobject";
    static final String classMetaobjectClassName
        = "info.novatec.inspectit.javassist.tools.reflect.ClassMetaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "info.novatec.inspectit.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("info.novatec.inspectit.javassist.tools.reflect.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("info.novatec.inspectit.javassist.tools.reflect.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("info.novatec.inspectit.javassist.tools.reflect.Metaobject"),
        ...
        f = new CtField(classPool.get("info.novatec.inspectit.javassist.tools.reflect.ClassMetaobject"),
