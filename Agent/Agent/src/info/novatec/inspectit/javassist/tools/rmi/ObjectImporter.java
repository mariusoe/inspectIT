 ...
 *
 * @see info.novatec.inspectit.javassist.tools.rmi.AppletServer
 * @see info.novatec.inspectit.javassist.tools.rmi.RemoteException
 * @see info.novatec.inspectit.javassist.tools.web.Viewer
 */
