...
package info.novatec.inspectit.javassist.tools.rmi;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "info.novatec.inspectit.javassist.tools.rmi.Sample";
     ...
     *
     * @see info.novatec.inspectit.javassist.Translator#start(ClassPool)
     */
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "info.novatec.inspectit.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "info.novatec.inspectit.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("info.novatec.inspectit.javassist.tools.rmi.RemoteException") };
    }

    /**
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see info.novatec.inspectit.javassist.Translator#onLoad(ClassPool,String)
     */
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("info.novatec.inspectit.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
