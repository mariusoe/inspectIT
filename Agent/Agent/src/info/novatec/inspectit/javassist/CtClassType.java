...
package info.novatec.inspectit.javassist;

import info.novatec.inspectit.javassist.bytecode.AccessFlag;
...
import info.novatec.inspectit.javassist.bytecode.Bytecode;
...
import info.novatec.inspectit.javassist.bytecode.ConstantAttribute;
import info.novatec.inspectit.javassist.bytecode.Descriptor;
import info.novatec.inspectit.javassist.bytecode.EnclosingMethodAttribute;
import info.novatec.inspectit.javassist.bytecode.FieldInfo;
import info.novatec.inspectit.javassist.bytecode.InnerClassesAttribute;
import info.novatec.inspectit.javassist.bytecode.MethodInfo;
import info.novatec.inspectit.javassist.bytecode.ParameterAnnotationsAttribute;
import info.novatec.inspectit.javassist.bytecode.annotation.Annotation;
import info.novatec.inspectit.javassist.compiler.AccessorMaker;
import info.novatec.inspectit.javassist.compiler.CompileError;
import info.novatec.inspectit.javassist.compiler.Javac;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see info.novatec.inspectit.javassist.CtClass#prune()
     * @see info.novatec.inspectit.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
