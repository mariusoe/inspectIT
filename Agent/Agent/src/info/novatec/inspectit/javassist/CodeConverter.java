...
import info.novatec.inspectit.javassist.convert.*;
 ...
 *
 * @see info.novatec.inspectit.javassist.CtClass#instrument(CodeConverter)
 * @see info.novatec.inspectit.javassist.CtMethod#instrument(CodeConverter)
...
public class CodeConverter {
     ...
     * @see info.novatec.inspectit.javassist.CtMethod#setName(String)
     */
