...
package info.novatec.inspectit.javassist.util.proxy;
 ...
 * {@link info.novatec.inspectit.javassist.util.proxy.ProxyObjectOutputStream} and {@link info.novatec.inspectit.javassist.util.proxy.ProxyObjectInputStream}
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "info.novatec.inspectit.javassist.util.proxy.RuntimeSupport";
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("info.novatec.inspectit.javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
                             "(Ljava/lang/Object;)Linfo/novatec/inspectit/javassist/util/proxy/SerializedProxy;");
        code.addOpcode(Opcode.ARETURN);
        minfo.setCodeAttribute(code.toCodeAttribute());
        return minfo;
    }
