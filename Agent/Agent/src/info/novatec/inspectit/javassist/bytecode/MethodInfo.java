...
import info.novatec.inspectit.javassist.bytecode.stackmap.MapMaker;
 ...
 * 
 * @see info.novatec.inspectit.javassist.CtMethod#getMethodInfo()
 * @see info.novatec.inspectit.javassist.CtConstructor#getMethodInfo()
 */
public final class MethodInfo {
	...
	/**
	 * The name of class initializer (static initializer): <code>&lt;clinit&gt</code>.
	 */
	...
	public void rebuildStackMap(ClassPool pool) throws BadBytecode {
		...
		if (ca != null) {
			try {
				...
				// this is a bad workaround, but we let the JVM make the decision if this class is
				// totally unreadable after the instrumentation ...
				System.out.println("Caught " + e.getClass() + " while trying to build StackMap, please consult the inspectIT management!");
			}
		}
	}
