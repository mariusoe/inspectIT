...
package info.novatec.inspectit.javassist.bytecode;

import info.novatec.inspectit.javassist.CtClass;
import info.novatec.inspectit.javassist.bytecode.annotation.AnnotationsWriter;
import info.novatec.inspectit.javassist.bytecode.annotation.MemberValue;
 ...
 * @see info.novatec.inspectit.javassist.bytecode.annotation.MemberValue
 */
...
public class AnnotationDefaultAttribute extends AttributeInfo {
     ...
     *
     * @param cp            constant pool
     * @see #setDefaultValue(info.novatec.inspectit.javassist.bytecode.annotation.MemberValue)
     */
     ...
     * @see info.novatec.inspectit.javassist.bytecode.annotation.Annotation#createMemberValue(ConstPool, CtClass)
     */
