 ...
 *
 * @see info.novatec.inspectit.javassist.ClassPool
 * @see info.novatec.inspectit.javassist.Translator
 */
public class Loader extends ClassLoader {
    ...
    private void init(ClassPool cp) {
        ...
        translator = null;
        domain = null;
        delegateLoadingOf("info.novatec.inspectit.javassist.Loader");
    }
     ...
     * </ul>
     *
     * @see info.novatec.inspectit.javassist.Loader#run(String[])
     */
    public static void main(String[] args) throws Throwable {
