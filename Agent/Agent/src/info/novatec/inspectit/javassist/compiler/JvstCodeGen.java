...
package info.novatec.inspectit.javassist.compiler;

import info.novatec.inspectit.javassist.*;
import info.novatec.inspectit.javassist.bytecode.*;
import info.novatec.inspectit.javassist.compiler.ast.*;
...
public class JvstCodeGen extends MemberCodeGen {
    ...
    public void atMember(Member mem) throws CompileError {
        ...
        if (name.equals(paramArrayName)) {
            ...
            bytecode.addInvokestatic("info/novatec/inspectit/javassist/runtime/Desc", "getParams",
    ...
    private void callGetType(String method) {
        bytecode.addInvokestatic("info/novatec/inspectit/javassist/runtime/Desc", method,
                                "(Ljava/lang/String;)Ljava/lang/Class;");
        exprType = CLASS;
        arrayDim = 0;
        className = "java/lang/Class";
    ...
    protected void atCflow(ASTList cname) throws CompileError {
        ...
        bytecode.addGetstatic((String)names[0], (String)names[1],
                              "Linfo/novatec/inspectit/javassist/runtime/Cflow;");
        bytecode.addInvokevirtual("info.novatec.inspectit.javassist.runtime.Cflow",
                                  "value", "()I");
        exprType = INT;
        arrayDim = 0;
        className = null;
