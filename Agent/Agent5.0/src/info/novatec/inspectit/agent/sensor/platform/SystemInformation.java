...
public class SystemInformation implements IPlatformSensor {
	 ...
	 * 
	 * @return The java class path that is used by the system class loader to
	 *         search for class files.
	 */
	 ...
	 * search for class files.
	 * 
	 * @return The boot class path that is used by the bootstrap class loader to
	 *         search for class files.
	 */
	...
	/**
	 * Returns the name representing the running virtual machine. for example:
	 * 12456@pc-name.
	 * 
	...
	/**
	 * Returns the initial amount of memory that the virtual machine requests
	 * from the operating system for heap memory management during startup.
	 * 
	 * @return The initial amount of memory that the virtual machine requests
	 *         from the operating system for heap memory management during
	 *         startup.
	 */
	...
	/**
	 * Returns the maximum amount of memory that can be used for heap memory
	 * management.
	 * 
	 * @return The maximum amount of memory that can be used for heap memory
	 *         management.
	 */
	...
	/**
	 * Returns the initial amount of memory that the virtual machine requests
	 * from the operating system for non-heap memory management during startup.
	 * 
	 * @return The initial amount of memory that the virtual machine requests
	 *         from the operating system for non-heap memory management during
	 *         startup.
	 */
	...
	/**
	 * Returns the maximum amount of memory that can be used for non-heap memory
	 * management.
	 * 
	 * @return The maximum amount of memory that can be used for non-heap memory
	 *         management.
	 */
