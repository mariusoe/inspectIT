...
public class HookDispatcherTest extends AbstractLogSupport {
	...
	public void dispatchManyMethodHooksWithoutInvocationTrace() {
		RegisteredSensorConfig registeredSensorConfig = mock(RegisteredSensorConfig.class);
		Map<Long, IMethodHook> methodHooks = new LinkedHashMap<Long, IMethodHook>();
		Map<Long, IMethodHook> reverseMethodHooks = new LinkedHashMap<Long, IMethodHook>();
	...
	public void dispatchOneMethodHookWithInvocationTrace() {
		...
		Map<Long, IMethodHook> methodHooksTwo = new LinkedHashMap<Long, IMethodHook>();
	...
	public void dispatchManyConstructorHooksWithoutInvocationTrace() {
		RegisteredSensorConfig registeredSensorConfig = mock(RegisteredSensorConfig.class);
		Map<Long, IConstructorHook> constructorHooks = new LinkedHashMap<Long, IConstructorHook>();
		Map<Long, IConstructorHook> reverseConstructorHooks = new LinkedHashMap<Long, IConstructorHook>();
