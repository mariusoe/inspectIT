...
public class PropertyUpdateExecutor implements BeanPostProcessor, BeanFactoryAware {
	...
	private static final class PropertyUpdateFieldInfo {
		...
		/**
		 * Returns true if the name of the property field is bounded to is macthing the logical name
		 * of the update property.
		 * 
		 * @param updatedProperty
		 *            {@link SingleProperty}.
		 * @return Returns true if the name of the property field is bounded to is macthing the
