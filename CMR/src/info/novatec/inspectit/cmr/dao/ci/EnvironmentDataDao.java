...
public interface EnvironmentDataDao {
	...
	/**
	 * Adds an {@link EnvironmentData} object into the database. Attached
	 * {@link SensorTypeData} objects are not included. They will be stored
	 * separately with following method
	 ...
	 *             If no {@link EnvironmentData} object matching the given id
	 *             could be found.
	 */
	void deleteEnvironment(long environmentId) throws EntityNotFoundException;

	/**
	 * Returns a list containing all stored {@link EnvironmentData} objects.
	 * Attached {@link ProfileDataDao}, {@link SensorTypeDataDao} and
	 * {@link TypeOptionData} objects are returned too.
	 * 
