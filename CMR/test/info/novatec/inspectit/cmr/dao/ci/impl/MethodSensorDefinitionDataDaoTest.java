...
public class MethodSensorDefinitionDataDaoTest extends AbstractTransactionalTestNGLogSupport {
	...
	/**
	 * The {@link SensorTypeData} to add an {@link SensorTypeData} object into the database.
	 */
	@Autowired
	...
	/**
	 * Stores a single {@link MethodSensorDefinitionData} object into the database. Storing is
	...
	/**
	 * Stores a single {@link MethodSensorDefinitionData} object into the database. Afterwards the
	 * {@link MethodSensorDefinitionData} object is retrieved and the values are compared to those
	...
	/**
	 * Stores a single {@link MethodSensorDefinitionData} object into the database. Then the
	 * {@link MethodSensorDefinitionData} object is changed and an update is performed. Afterwards
	 * the {@link MethodSensorDefinitionData} object is retrieved and the values are compared to
	...
	/**
	 * Stores a single {@link MethodSensorDefinitionData} object into the database and afterwards
	...
	/**
	 * Stores a single {@link SensorTypeData} object into the database. Afterwards this object is
	 * retrieved an assigned to a {@link MethodSensorDefinitionData} object which is also stored.
	 * Then the {@link MethodSensorDefinitionData} object is retrieved and the values of the
	 * assigned {@link SensorTypeData} object is compared to the values of the initially created
	 * {@link SensorTypeData} object. These values should be equal for a successful test.
	 */
	 ...
	 * {@link MethodSensorDefinitionData} object should also be deleted. The deletion afterwards of
	 * the {@link MethodSensorDefinitionData} object should cause an {@link EntityNotFoundException}
	 * .
	 * 
	 * @throws EntityNotFoundException
	 *             If object is not found.
