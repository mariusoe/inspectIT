...
public class PlatformSensorDefinitionDataDaoTest extends AbstractTransactionalTestNGSpringContextTests {
	...
	/**
	 * Stores a single {@link PlatformSensorDefinitionData} object into the
	 * database. Afterwards the {@link PlatformSensorDefinitionData} object is
	...
	/**
	 * Stores a single {@link PlatformSensorDefinitionData} object into the
	 * database. Then the {@link PlatformSensorDefinitionData} object is changed
	 * and an update is performed. Afterwards the
	 * {@link PlatformSensorDefinitionData} object is retrieved and the values
	 ...
	 * During the deletion the {@link PlatformSensorDefinitionData} object
	 * should also be deleted. The deletion afterwards of the
	 * {@link PlatformSensorDefinitionData} object should cause an
