...
public class ProfileDataDaoTest extends AbstractTransactionalTestNGLogSupport {
	...
	/**
	 * Stores a single {@link ProfileData} object into the database. Storing is
	...
	/**
	 * Stores a single {@link ProfileData} object into the database. Afterwards
	 * the {@link ProfileData} object is retrieved and the values are compared
	...
	/**
	 * Stores a single {@link ProfileData} object into the database. Then the
	 * {@link ProfileData} object is changed and an update is performed.
	 * Afterwards the {@link ProfileData} object is retrieved and the values are
	...
	/**
	 * Stores a single {@link ProfileData} object into the database and
	...
	/**
	 * This method tries to retrieve a {@link ProfileData} object which is not
	 * available. Test is successfully if null is the return value.
	 */
	...
	/**
	 * This method tests if a profile is also deleted when its parent, the
	 * environment, is deleted. Therefore the initial added environment will be
	 * deleted. Test is successful when null is returned.
	 * 
	 * @throws EntityNotFoundException
