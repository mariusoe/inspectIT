...
public class SensorTypeDataDaoTest extends AbstractTransactionalTestNGLogSupport {
	...
	/**
	 * Stores a single {@link SensorTypeData} object into the database. Storing is successful if the
	...
	/**
	 * Stores a single {@link SensorTypeData} object into the database. Afterwards the
	 * {@link SensorTypeData} object is retrieved and the values are compared to those of the
	 * original object.
	 */
	 ...
	 * {@link SensorTypeData} object is changed and an update is performed. Afterwards the
	 * {@link SensorTypeData} object is retrieved and the values are compared to those of the first
	...
	/**
	 * Stores a single {@link SensorTypeData} object into the database. Then the associated
	 * {@link EnvironmentData} object is deleted. During the deletion the {@link SensorTypeData}
	 * object should also be deleted. The deletion afterwards of the {@link SensorTypeData} object
	 * should cause an {@link EntityNotFoundException}.
	 * 
