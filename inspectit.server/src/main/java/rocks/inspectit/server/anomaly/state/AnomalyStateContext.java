 ...
 *
 */
public class AnomalyStateContext {
	...
	private HealthStatus anomalyHealthStauts = HealthStatus.UNKNOWN;
	 ...
	 */
	public HealthStatus getAnomalyHealthStauts() {
		return this.anomalyHealthStauts;
	}
	 ...
	 */
	public void setAnomalyHealthStauts(HealthStatus healthStauts) {
		this.anomalyHealthStauts = healthStauts;
	}
